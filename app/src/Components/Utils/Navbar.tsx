...
const rolePermissions: { [key: string]: string[] } = {
  'Administrateur': [
    ...
    '/accountcreation',
    '/assigned-courses',
    '/my-affectations', // Optionnel : ajouter pour les admins si tu veux
  ],
  'Professeur': [
    '/my-affectations', // Ajouté pour les professeurs
  ],
      ...
      <div className="flex space-x-6">
        {isLoggedIn && (
          <>
            ...
            {isLinkAllowed('/my-affectations') && (
              <div className="flex items-center">
                <Link to="/my-affectations" className="text-sm hover:text-green-300 transition duration-200">
                  Mes affectations
                </Link>
              </div>
            )}
